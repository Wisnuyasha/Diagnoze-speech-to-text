              ...
              <div className="mx-8">
                <ul className="space-y-2 font-medium mt-8 hover:text-white">
                  <li className="rounded-full flex items-center bg-[#45486E]">
                    <a
                      href="#"
                      className="flex items-center text-center justify-center p-4 text-white rounded-lg px-5"
                    >
                      <svg
                  ...
                  <li className="rounded-full flex items-center hover:bg-[#45486E] hover:text-white">
                    <a
                      href="/hospitals"
                      className="flex items-center text-center justify-center p-4 text-black rounded-lg hover:text-white px-5"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                  ...
                  <li className="rounded-full flex items-center hover:bg-[#45486E]">
                    <a
                      href="#"
                      className="flex items-center text-center justify-center p-4 text-black hover:text-white rounded-lg px-5"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
